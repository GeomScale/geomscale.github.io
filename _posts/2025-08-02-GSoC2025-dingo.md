...
Functions regarding computing pairwise reaction correlations, clustering and graphs analysis from `dingo` have been updated and improved and permanently moved to `dingo-stats`. The removal of these functions from `dingo` was completed in this [Pull Request](). These functions will not be presented in this blog, but users are encouraged to study the new functionalities in the [dingo-stats documentation](https://dingo-stats.readthedocs.io/en/latest/index.html).
